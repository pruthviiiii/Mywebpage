...
function HobbiesandInterests() {
  return (
    <div className="pt-32  bg-white  dark:bg-Dark-modeC ">
      <br />
      <br />
      <br />
      <h1 className="text-3xl font-semibold text-left dark:text-white">
        Traveling ✈ and Food 🍲
      </h1>
      <br />
      <br />
      ...
      <p className="text-left dark:text-white text-sm sm:text-base">
        ...
        thrilling sports out there, I enjoy watching battle amoung mid feild. If
        you love F1 lets catch up on race weekend or include me into your peers.
      </p>
      <br />
      <br />
      <h1 className="text-3xl font-semibold text-left dark:text-white">
      ...
      <p className="text-left dark:text-white text-sm sm:text-base">
        ...
        managed to gain admission and pursue undergratuate in Engineering. Got
        hooked to JavaScript when I started coding and was fascinated about the
        ecosystem. I was lucky enough to have people support me in all hobbies
        and activities that I pursued and had a really fulfilling life so far.
      </p>
      <br />
      <br />
    </div>
